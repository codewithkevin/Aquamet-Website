...
import {
  ...
  useScrollFadeAnimationLeft,
  useScrollFadeAnimationRight,
} from "../Essentials/useScrollFadeAnimation";
...
const About = () => {
  ...
  const controls = useScrollFadeAnimation();
  const controlsLeft = useScrollFadeAnimationLeft();
  const controlsRight = useScrollFadeAnimationRight();
          ...
          <div className="md:mt-10 sm:mt-4">
            ...
            <div className="flow-root ... max-w-2xl  mt-2 md:space-y-2 space-y-5">
              ...
              <p className="font-serif text-[18px] leading-[28px] text-gray-600 font-normal">
                ...
                online(voice messages and interactive app) and offline.
              </p>
              <p className="font-serif text-[18px] leading-[28px] text-gray-600 font-normal">
