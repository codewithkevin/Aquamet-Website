  ...
  return (
    <section>
      ...
      <div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-4 justify-center mx-4 p-5">
          <div class="col-span-1 p-4 mb-20 text-center space-y-3">
