  ...
  return (
    <section className="mt-10 md:mt-20 h-full w-full">
      <div className="flex md:flex-row sm:flex-col mx-5 lg:mx-[16rem] lg lg:max-40 pb-4 space-y-3 md:space-x-10 lg:space-x-5">
        <div className="flex flex-col basis-1/2 mt-0 md:mt-24 sm:mb-10">
        ...
        <div className="md:hidden sm:flex sm:justify-center flex items-center justify-center w-[285px] h-[431px] mb-0 pb-2  mx-auto">
          <img src={phone2} alt="" />
        </div>

        <div className="basis-1/2 sm:mr-28 md:block sm:hidden md:pb-2 lg:pb-5">
