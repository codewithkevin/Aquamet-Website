      ...
      <div className="mb-7  lg:mb-14">
        ...
        <div className="mt-4">
          ...
          <div className="mx-0 mt-5 space-y-4 max-w-auto sm:mx-5  sm:flex sm:flex-col sm:items-center md:text-justify md:max-w-lg lg:max-w-lg">
            <p className="">
              We are driven by the huge potential in the aquaculture industry as
              a prominent way of reducing Ghana’s 62% fish deficit. We are keen
              on empowering more small holder farmers and new and potential
              farmers with the needed tools to make their production
              sustainable.
            </p>
            <p className="">
              With our interest in providing the needed resources for farmers to
              make more, our team is made up of engineers, software developers
              and aquaculture experts who are obsessed with growth.
            </p>
            <p className="">
      ...
      <div className="mt-5 mx-5 mb-7  lg:mb-14">
        <div className="lg:flex lg:flex-row lg:justify-evenly grid grid-cols-1 gap-14 md:grid-cols-2 lg:grid-cols-2 lg:space-x-7">
          <div className="mt-5 lg:mt-20">
            ...
            <p className="flow-root ... max-w-md text-gray-600 leading-[32px] mt-5 font-serif">
              Our mission is to revolutionize the aquaculture industry in Ghana
              by providing innovative technology solutions that enable farmers
              to monitor water quality remotely and improve their production
              yield, resulting in higher profits and more sustainable practices.
            </p>
          </div>
          ...
          <div className="mt-5 lg:mt-20">
            ...
            <p className="flow-root ... max-w-md text-gray-600 leading-[32px] mt-5 font-serif">
              Our vision is to be the leading aquaculture technology company in
              Ghana, known for our innovative solutions that transform the
              industry and create sustainable practices for the future. We
              envision a future where farmers can produce high-quality fish in a
              cost-effective and environmentally friendly way, thanks to the
        ...
        <div className="lg:flex lg:flex-row lg:justify-evenly grid grid-cols-1 gap-14 md:grid-cols-2 lg:grid-cols-2 lg:space-x-7">
          <div className="mt-5 md:mt-20 ">
            <div className=" md:text-left sm:text-center">
              <strong className="text-3xl  font-serif">Our Core Values</strong>
            </div>

            <p className="flow-root ... max-w-md text-gray-600 leading-[32px] mt-5 font-serif">
              Passion: We are passionate about innovation and sustainability in
              aquaculture.
            </p>
            <p className="flow-root ... max-w-md text-gray-600 leading-[32px] mt-5 font-serif">
            ...
            <p className="flow-root ... max-w-md text-gray-600 leading-[32px] mt-5 font-serif">
              ...
              service and support, and to building strong relationships with our
